...
## Corpus Check
- 290 files · ~311,388 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2879 nodes · 3846 edges · 214 communities (199 shown, 15 thin omitted)
...
- `createEmployee()` --calls--> `api()`  [EXTRACTED]
  frontend/src/views/EmployeesView.vue → frontend/src/lib/api.ts
...
Cohesion: 0.16
Nodes (9): auth, router, { t }, AuthUser, Envelope, useAuthStore, auth, { t } (+1 more)
...
Cohesion: 0.09
Nodes (26): allowanceSchema, createContractSchema, createDeptSchema, createEmployeeSchema, fxRefreshSchema, registerHrRoutes(), ServiceConfig, { app, log } (+18 more)
...
Cohesion: 0.20
Nodes (9): DisbursementReport, disbursements, error, from, load(), loading, Portfolio, { t, locale } (+1 more)
...
Cohesion: 0.17
Nodes (15): api(), approveRun(), auth, busy, calculate(), createRun(), error, load() (+7 more)
...
Cohesion: 0.15
Nodes (14): approve(), busy, createRequest(), Employee, employees, error, form, LeaveRequest (+6 more)
...
## Knowledge Gaps
- **1885 isolated node(s):** `name`, `version`, `private`, `type`, `main` (+1880 more)
...
- **Why does `13 — Offline-First and Field Operations Architecture` connect `13 — Offline-First and Field Operations Architecture` to `sdd/README.md`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `19 — Frontend Architecture` connect `19 — Frontend Architecture` to `sdd/README.md`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
