# Graph Report - NGO Intelligence Suite  (2026-07-30)

## Corpus Check
- 385 files · ~345,556 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3511 nodes · 4571 edges · 253 communities (236 shown, 17 thin omitted)
...
Cohesion: 0.03
Nodes (70): scripts, accountant:review-pack, build, build:backend, build:frontend, canary:analysis-stub, canary:local, chaos:catalogue (+62 more)
...
Cohesion: 0.10
Nodes (21): props, { t }, formatMoney(), statusLabel(), createGrant(), error, form, Grant (+13 more)
...
Cohesion: 0.06
Nodes (25): Checklist, Data subject rights, Superseded, Erasure + DSAR, Lawful bases, Phase 3 DPIA — Beneficiary / field data (DPO-approved), Retention, Risks & mitigations (+17 more)
...
Cohesion: 0.12
Nodes (16): describedBy, emit, id, props, busy, createEmployee(), Department, departments (+8 more)
...
## Knowledge Gaps
- **2276 isolated node(s):** `name`, `version`, `private`, `type`, `main` (+2271 more)
